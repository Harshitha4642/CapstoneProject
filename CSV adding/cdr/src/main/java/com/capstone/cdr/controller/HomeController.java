...
public class HomeController {
	...
	{
		System.out.println("i am trying to save normal call form");
		ExcecutionStatus status = new ExcecutionStatus();
		status = homeService.saveCDRService(form, false);
		return status;
	}
	...
	{
		System.out.println("i am trying to save failed call form");
		ExcecutionStatus status = new ExcecutionStatus();
		status = homeService.saveCDRService(form, true);
		return status;
	}
}
